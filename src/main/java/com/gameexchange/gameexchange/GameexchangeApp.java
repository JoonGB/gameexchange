package com.gameexchange.gameexchange;
...
public class GameexchangeApp {

    private static final Logger log = LoggerFactory.getLogger(GameexchangeApp.class);

    @Inject
    private Environment env;

    /**
     * Initializes gameexchange.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(GameexchangeApp.class);
